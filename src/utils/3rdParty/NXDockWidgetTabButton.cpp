...
NXDockWidgetTabButton::NXDockWidgetTabButton(const QString& text, Qt::DockWidgetArea area)
    : QPushButton(text, nullptr), m_mirrored(false), m_area(area), m_action(nullptr) {
    setToolTip(text);
...
NXDockWidgetTabButton::~NXDockWidgetTabButton() { qDebug() << "NXDockWidgetTabButton dtor"; }
