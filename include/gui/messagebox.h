...
public:
    MessageBox(const QString &message, bool cancel_button_visible = true); // 创建对话框
    MessageBox(QWidget *w, bool cancel_button_visible = true);             // 创建窗体
    ~MessageBox();
...
private:
    static void setMessageBoxForTopWindow(TopWindow *window, int width, int height); // 设置 TopWindow 的属性
